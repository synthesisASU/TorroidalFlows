...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 1033.0, 387.0, 318.0, 22.0 ],
					"saved_object_attributes" : 					{
						"initial" : [ 1.0 ],
						"parameter_enable" : 0
					}
,
					"style" : "",
					"text" : "pattr c @bindto unperturbed::rotation_deviance @initial 1.",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"varname" : "c"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 1033.0, 356.0, 344.0, 22.0 ],
					"saved_object_attributes" : 					{
						"initial" : [ 1.0 ],
						"parameter_enable" : 0
					}
,
					"style" : "",
					"text" : "pattr b @bindto unperturbed::overturning_circulation @initial 1.",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"varname" : "b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 1033.0, 326.0, 306.0, 22.0 ],
					"saved_object_attributes" : 					{
						"initial" : [ 1.0 ],
						"parameter_enable" : 0
					}
,
					"style" : "",
					"text" : "pattr a @bindto unperturbed::horizontal_swirl @initial 1.",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"varname" : "a"
				}
