...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 375.5, 124.0, 310.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 613.5, 318.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "jit_gl_texture", "", "" ],
					"patching_rect" : [ 613.5, 278.0, 388.0, 22.0 ],
					"style" : "",
					"text" : "jit.gl.node turtles @name turtle-node @capture 1 @erase_color 0 0 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 493.0, 278.0, 55.0, 22.0 ],
					"style" : "",
					"text" : "jit.matrix"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 48.0, 572.0, 322.0, 22.0 ],
					"style" : "",
					"text" : "jit.gl.mesh turtle-node @draw_mode points @point_size 5."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 426.5, 331.0, 150.0, 20.0 ],
					"style" : "",
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 338.0, 304.0, 150.0, 47.0 ],
									"style" : "",
									"text" : "Safety for case of float between 0 & 1 being entered"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 291.0, 309.0, 45.0, 22.0 ],
									"style" : "",
									"text" : ">= 0.5"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 291.0, 278.0, 282.0, 22.0 ],
									"style" : "",
									"text" : "param colormode 0. @min 0. @max 1. @default 0."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 291.0, 353.0, 40.0, 22.0 ],
									"style" : "",
									"text" : "?"
								}
...
, 							{
								"box" : 								{
									"code" : "/*create each color in a regular\r\ngrid based on position inside \r\nthe matrix */\r\nred  = (norm.x * 0.75) + 0.25;\r\ngreen = (norm.y * 0.75) + 0.25;\r\nblue = norm.x * norm.y; //don't scale here, already done on r&g\r\n\r\nout1 = vec(red,green,blue);",
									"fontface" : 0,
									"fontname" : "Arial",
									"fontsize" : 12.0,
									"id" : "obj-2",
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 369.0, 48.0, 469.0, 196.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									"code" : "//get the color components\r\nred = swiz(in1, 0);\r\ngreen = swiz(in1, 1);\r\nblue = swiz(in1, 2);\r\n\r\n//shift the range to be 0.25 -> 1.\r\nred = (red * 0.75) + 0.25;\r\ngreen = (green * 0.75) + 0.25;\r\nblue = (blue * 0.75) + 0.25;\r\n\r\n//output the conformed color values\r\nout1 = vec(red,green,blue);",
									"fontface" : 0,
									"fontname" : "Arial",
									"fontsize" : 12.0,
									"id" : "obj-5",
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 48.0, 288.0, 220.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 291.0, 389.0, 37.0, 22.0 ],
									"style" : "",
									"text" : "out 1"
								}
...
,
					"patching_rect" : [ 418.0, 349.0, 43.0, 22.0 ],
					"style" : "",
					"text" : "jit.gen"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 53.5, 318.0, 154.0, 33.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 62.0, 199.0, 156.0, 33.0 ],
					"style" : "",
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 678.0, 22.0, 95.0, 22.0 ],
									"style" : "",
									"text" : "param zPos 0.5"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 635.0, 52.0, 383.0, 320.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 521.0, 399.0, 37.0, 22.0 ],
									"style" : "",
									"text" : "out 2"
								}
...
, 							{
								"box" : 								{
									"code" : "//get the position data\r\nx = in1.r;\r\ny = in1.g;\r\nz = in1.b;\r\n\r\n//conform the x & y planes to be signed normalized (-1 to 1)\r\n//x = (x * 2) - 1;\r\n//y = (y * 2) - 1;\r\n\r\nx = x - 0.5;\r\ny = y - 0.5;\r\n\r\n//return the adjusted data\r\nout1 = vec(x,y,z,1);\r\nout2 = vec(in1.r,in1.g,in1.b,1);",
									"fontface" : 0,
									"fontname" : "Arial",
									"fontsize" : 12.0,
									"id" : "obj-5",
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 50.0, 63.0, 490.0, 287.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 50.0, 413.0, 37.0, 22.0 ],
									"style" : "",
									"text" : "out 1"
								}
...
,
					"patching_rect" : [ 235.0, 233.0, 43.0, 22.0 ],
					"style" : "",
					"text" : "jit.gen"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 160.0, 112.0, 77.0, 22.0 ],
					"style" : "",
					"text" : "prepend dim"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 43.0, 112.0, 24.0, 22.0 ],
					"style" : "",
					"text" : "t b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 235.0, 298.0, 93.0, 22.0 ],
					"style" : "",
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 748.0, 181.0, 114.0, 22.0 ],
									"style" : "",
									"text" : "param stepSize 0.1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 748.0, 144.0, 101.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 748.0, 113.0, 74.0, 22.0 ],
									"style" : "",
									"text" : "param c 0.1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 748.0, 83.0, 75.0, 22.0 ],
									"style" : "",
									"text" : "param b 0.1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 748.0, 53.0, 75.0, 22.0 ],
									"style" : "",
									"text" : "param a 0.1"
								}
...
,
					"patching_rect" : [ 35.0, 353.0, 216.0, 22.0 ],
					"style" : "",
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 93.0, 226.0, 31.0, 22.0 ],
									"style" : "",
									"text" : "- 12"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 70.899994, 100.0, 40.0, 22.0 ],
									"style" : "",
									"text" : "t i i i"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 93.0, 199.0, 29.5, 22.0 ],
									"style" : "",
									"text" : "i"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "bang", "bang", "" ],
									"patching_rect" : [ 70.899994, 162.0, 46.0, 22.0 ],
									"style" : "",
									"text" : "sel 0 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 70.899994, 135.0, 34.0, 22.0 ],
									"style" : "",
									"text" : "> 12"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 70.899994, 40.0, 30.0, 30.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 65.5, 308.0, 30.0, 30.0 ],
									"style" : ""
								}
...
,
					"patching_rect" : [ 776.900024, 145.0, 121.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "bang", "int" ],
					"patching_rect" : [ 645.5, 233.0, 40.0, 22.0 ],
					"style" : "",
					"text" : "text"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 645.5, 206.0, 83.0, 22.0 ],
					"style" : "",
					"text" : "prepend write"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 645.5, 177.0, 238.0, 22.0 ],
					"style" : "",
					"text" : "sprintf particles-%d-%d-%d_%d-%d-%d.txt"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 776.900024, 112.0, 150.400024, 22.0 ],
					"style" : "",
					"text" : "unjoin 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 645.5, 64.0, 150.399994, 22.0 ],
					"style" : "",
					"text" : "unjoin 3"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 79.0, 112.0, 67.0, 22.0 ],
					"style" : "",
					"text" : "t date time"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 43.0, 76.0, 175.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 645.5, 25.0, 281.799988, 22.0 ],
					"style" : "",
					"text" : "date"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 43.0, 34.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 210.5, 323.0, 150.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 407.0, 206.0, 150.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 475.5, 360.0, 150.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 44.5, 378.0, 21.0, 378.0, 21.0, 294.0, 244.5, 294.0 ],
					"source" : [ "obj-27", 0 ]
				}
